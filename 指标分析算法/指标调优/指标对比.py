...
def zhibiao(test_size,random_state,qvyv,time):
    ...
    if improvement_percentage(r2_ols, r2_xgb, higher_better=True) >= -30 and improvement_percentage(r2_ols, r2_xgb, higher_better=True) < 99:
        ...
        return test_size,random_state,improvement_percentage(r2_ols, r2_xgb, higher_better=True),all_data
    else:
        return test_size,random_state,0,0
